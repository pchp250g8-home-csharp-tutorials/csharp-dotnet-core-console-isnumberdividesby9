IsNumberDividesBy9. C# Tutorials. DotNet Core Platform. Algorithms. Simple Input/Output. Console Application.
...
The DotNet Core Platform provides simple input/output. Determining the sum of digits in a number entered from the keyboard.
...
IsNumberDividesBy9. Занятия по С#. Платформа DotNet Core. Алгоритмы. Простой ввод/вывод. Консольное приложение.
...
Платформа DotNet Core. Простой ввод-вывод. Определение суммы цифр в числе, введённом с клавиатуры. Ответ на вопрос делится ли данное число на 9.
Данная программа делает следующее:
  ...
  7. На экран выводится ответ на вопрос делится ли данное чилсло на 9.
